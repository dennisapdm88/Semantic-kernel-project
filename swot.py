...
async def main():
    shift_domain_result = await kernel.run_async(shift_domain_function, input_str=my_context['input'], domain=my_context['domain'])
    print("\n=== Shifted Domain Analysis ===")
    print(str(shift_domain_result))
...
async def main():
    shift_reading_level_result = await kernel.run_async(shift_reading_level_function, input_str=my_context['input'], level=my_context['level'])
    print("\n=== Shifted Reading Level Analysis ===")
    print(str(shift_reading_level_result))
